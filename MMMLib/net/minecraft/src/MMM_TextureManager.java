...
public class MMM_TextureManager {
	...
	public static String defNames[] = {
			"mob_littlemaid0.png", "mob_littlemaid1.png", "mob_littlemaid2.png", "mob_littlemaid3.png", "mob_littlemaid4.png", "mob_littlemaid5.png",
			"mob_littlemaid6.png", "mob_littlemaid7.png", "mob_littlemaid8.png", "mob_littlemaid9.png", "mob_littlemaida.png", "mob_littlemaidb.png",
			"mob_littlemaidc.png", "mob_littlemaidd.png", "mob_littlemaide.png", "mob_littlemaidf.png", "mob_littlemaidw.png", "mob_littlemaid_a00.png",
	...
	/**
	 * Entity毎にデフォルトテクスチャを参照。 構築方法はEntityListを参照のこと。
	 */
	...
	/**
	 * 渡された名称を解析してLMM用のモデルクラスかどうかを判定する。 「ModelLittleMaid_」という文字列が含まれていて、
	...
	/**
	 * テクスチャパック名に対応するインデックスを返す。 基本サーバー用。
	 * 
	 * @param pEntity
	 * @param pPackName
	 * @return
	...
	public MMM_TextureBoxServer getTextureBoxServer(int pIndex) {
		// mod_MMM_MMMLib.Debug("getTextureBoxServer: %d / %d", pIndex,
		// textureServer.size());
			...
			try {
				...
				while ((ls = br.readLine()) != null) {
					...
					if (lt.length >= 7) {
						...
						lbox.setModelSize(Float.valueOf(lt[2]), Float.valueOf(lt[3]), Float.valueOf(lt[4]), Float.valueOf(lt[5]));
	...
	public void saveTextureServer() {
		...
		try {
			...
			for (MMM_TextureBoxServer lbox : textureServer) {
				bw.write(String.format("%04x,%04x,%f,%f,%f,%f,%s", lbox.getContractColorBits(), lbox.getWildColorBits(), lbox.getHeight(null),
						lbox.getWidth(null), lbox.getYOffset(null), lbox.getMountedYOffset(null), lbox.textureName));
				bw.newLine();
			}
	...
	public void setDefaultTexture(Class pEntityClass, MMM_TextureBox pBox) {
		...
		mod_MMM_MMMLib.Debug("appendDefaultTexture:%s(%s)", pEntityClass.getSimpleName(), pBox == null ? "NULL" : pBox.textureName);
	}
