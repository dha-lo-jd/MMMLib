...
public abstract class MMM_ModelMultiBase
	...
	public MMM_ModelRenderer getRandomModelBoxMM(Random par1Random) {
		...
		MMM_ModelRenderer lmr = (MMM_ModelRenderer) boxList.get(li);
		for (int lj = 0; lj < boxList.size(); lj++) {
			...
			lmr = (MMM_ModelRenderer) boxList.get(li);
		}
		return lmr;
	}
	 ...
	 */
	public void renderStabilizer(float par2, float par3,
	...
	@Override
	@Deprecated
	public final void setTextureOffset(String par1Str, int par2, int par3) {
		setTextureOffsetMM(par1Str, par2, par3);
	}

	public void setTextureOffsetMM(String par1Str, int par2, int par3) {
